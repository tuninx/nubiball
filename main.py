...
arena_cover = ['🎯К дереву', '🎯В сугроб', '🎯За снеговика']
arena_attack = ['🙈У дерева', '🙈В сугробе', '🙈За снеговиком']
...
def parse_text(text, username, message_id):
    ...
    if bot_enabled and username == bot_username:
        ...
        elif arena_enabled and text.find('где спрятаться и куда кидать снежок') != -1:
        ...
        elif text.find('оказался точнее в метании') != -1 or text.find('Ничья') != -1:
